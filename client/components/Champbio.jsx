    ...
    return(
      <div className="champBio">
				...
				<div className="mainContent">
					...
					<br/><br/>
					A number of summoners in the League grew concerned that the perceived objectivity of the League of Legends would be questioned by the presence of an unknown fighter who was unbeatable.
					<br/><br/>
